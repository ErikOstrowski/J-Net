...
import cv2
from dataset_16 import *
from JNet_16 import UNet
from utils import *
from config_16 import *
...
for epoch in range(start_epoch,num_epochs):
    ...
    for batch_idx, data in enumerate(train_loader, 1):
        ...
        output1, output2, output3, output4, output5 = net(img.float())
        ...
        loss2 = loss_fn(output2,lable2)
        loss3 = loss_fn(output3,lable3)
        loss4 = loss_fn(output4, lable4)
    ...
    with torch.no_grad():
        ...
        for batch_idx, data in enumerate(val_loader, 1):
            ...
            output1, output2, output3, output4, output = net(img)
